...
| `npx jevelry tui [--jevel <name>]` | a full-screen terminal view of the log: today's decisions, a review queue where a person presses `c` (correct) or `w` (wrong), and Try to ask a jevel live |
